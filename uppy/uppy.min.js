...
"use strict";var _appendChild=require("yo-yoify/lib/appendChild"),_onload=require("on-load"),CameraIcon=require("./CameraIcon");module.exports=function(e){var t,a,n,o,r,c=e.src||"",s=void 0;if(e.useTheFlash)s=e.getSWFHTML();else{var i;i=document.createElement("video"),i.setAttribute("autoplay","autoplay"),i.setAttribute("src",""+String(c)),i.setAttribute("class","UppyWebcam-video"),s=i}return r=document.createElement("div"),_onload(r,function(t){e.onFocus(),document.querySelector(".UppyWebcam-stopRecordBtn").focus()},function(t){e.onStop()},6),r.setAttribute("class","UppyWebcam-container"),_appendChild(r,[" ",(t=document.createElement("div"),t.setAttribute("class","UppyWebcam-videoContainer"),_appendChild(t,[" ",s," "]),t)," ",(n=document.createElement("div"),n.setAttribute("class","UppyWebcam-buttonContainer"),_appendChild(n,[" ",(a=document.createElement("button"),a.setAttribute("type","button"),a.setAttribute("title","Take a snapshot"),a.setAttribute("aria-label","Take a snapshot"),a.onclick=e.onSnapshot,a.setAttribute("class","UppyButton--circular UppyButton--red UppyButton--sizeM UppyWebcam-stopRecordBtn"),_appendChild(a,[" ",CameraIcon()," "]),a)," "]),n)," ",(o=document.createElement("canvas"),o.setAttribute("style","display: none;"),o.setAttribute("class","UppyWebcam-canvas"),o)," "]),r};
